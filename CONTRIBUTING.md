...
- **Bugs**: open an issue using the bug-report template. Include the skill version (`#v0.1.2` or `#v0` — the `npx skills add` ref you installed with), your agent + version, and the JSON output the skill produced if relevant.
