...
> **Version**: `v0.1.0` — plans live in [`tasks/0.1.0/`](./tasks/0.1.0/). Pin `#v0` to track the latest 0.x release; pin a precise tag (`#v0.1.0`) to opt out of automatic minor/patch updates — see [Pinning a version](#pinning-a-version) below. Tracking task in the parent project: [`tasks/0.5.0/03-agent-skill.md`](https://github.com/hsnice16/agent-friendly-code/blob/main/tasks/0.5.0/03-agent-skill.md).
...
npx skills add hsnice16/agent-friendly-skill#v0.1.0   # precise tag — never updates
```
